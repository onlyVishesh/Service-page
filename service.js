...
ambulancesList.forEach((ambulance) => {
  ...
  <abbr title="${ambulance.name}">
    <img loading="lazy" src="images/ambulance/${ambulance.name}.webp" alt="${ambulance.name} Ambulance image" class="ambulance-img ${ambulance.name}-ambulance-img">
  </abbr>
  <abbr title="${ambulance.name}">
    ...
    ambulance.addEventListener("click", () => {
                    ...
                    <div class="flip-card selected-ambulance-features">
                      <div class="flip-card-inner">
                        <div class="flip-card-front">
                          <img loading="lazy" src="images/ambulance/features/${
                              ambulances.name
                          }/FEATURES ${
                        ambulances.features.indexOf(feature) + 1
                    }.webp" alt="${ambulances.name}"
        ...
        <div class="selected-ambulance-img">
          <figure class="selected-ambulance-outer-figure">
            <img loading="lazy" src="images/ambulance/${ambulances.name}.webp" alt="${ambulances.name}" class="selected-ambulance-outer-img">
          </figure>
          <figure class="selected-ambulance-inner-figure">
            <img loading="lazy" src="images/ambulance/inner-${ambulances.name}.webp" alt="${ambulances.name} interior" class="selected-ambulance-inner-img">
          </figure>
        </div>
